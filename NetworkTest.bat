...
:VariableAssign
SET title=Network Test [Alpha Release]
SET color=C
SET lines=300
SET cols=80
SET MainMenuPass=0
...
ECHO [3] POWERSHELL SCRIPTS (Not In Aplha)      [    Gateway Status: %DisplayGatewayState_Pre_Buffer%%DisplayGatewayState%%DisplayGatewayState_Post_Buffer%]
...
ECHO [5] REPAIR                                 -----------------------------------
ECHO [6] SETTINGS (Glitchy)                     [  Ethernet Adapter: %DisplayConnectMeth1_Pre_Buffer%%DisplayConnectMeth1%%DisplayConnectMeth1_Post_Buffer%]
...
SET MainMenuPass=0
ECHO Please select an option:                   -----------Network Stats-----------
ECHO                                            [   Internet Status: %DisplayOnlineState_Pre_Buffer%%DisplayOnlineState%%DisplayOnlineState_Post_Buffer%]
ECHO Powershell Scripts are not avalible        [    Network Status: %DisplayNetworkState_Pre_Buffer%%DisplayNetworkState%%DisplayNetworkState_Post_Buffer%]
ECHO In the Alpha Release, Please try again     [    Gateway Status: %DisplayGatewayState_Pre_Buffer%%DisplayGatewayState%%DisplayGatewayState_Post_Buffer%]
ECHO later!                                     [ DNS Server Status: %DisplayDNSState_Pre_Buffer%%DisplayDNSState%%DisplayDNSState_Post_Buffer%]
ECHO                                            -----------------------------------
ECHO [B] Back to menu                           [      Lease Status: %DisplayLeaseState_Pre_Buffer%%DisplayLeaseState%%DisplayLeaseState_Post_Buffer%]
ECHO [E] Exit                                   -----------------------------------
ECHO                                            [  Ethernet Adapter: %DisplayConnectMeth1_Pre_Buffer%%DisplayConnectMeth1%%DisplayConnectMeth1_Post_Buffer%]
...
ECHO ===============================================================================
ECHO Programmed by Caen Jones and Grant Arrington
ECHO V 1 (Alpha Release)
ECHO Main functions added, Powershell scripts still in development
ECHO Got all scanning tools working in 3/2/2023
ECHO Grant added settings menue in 3/3/2023
ECHO Settings menue still glitchy, but now can change 
ECHO consoles color
